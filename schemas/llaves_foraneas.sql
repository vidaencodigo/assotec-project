...
ALTER TABLE `agenda_table` ADD CONSTRAINT `usuario` FOREIGN KEY (`id_usuario`) REFERENCES `users_table` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `agenda_table` ADD CONSTRAINT `materia` FOREIGN KEY (`id_materia`) REFERENCES `materias_agenda_table` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
*/
